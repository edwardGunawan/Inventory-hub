...
//
// const TEXT_SIZE = 8
// const CONTENT_LEFT_PADDING = 5
// //TODO: generate some good pdf shit
// function PDFInvoice({
//   company, // {phone, email, address}
//   customer, // {name, email}
//   items, // [{amount, name, description,brand,...}]
// }){
//   const date = new Date()
//   const charge = {
//     createdAt: `${date.getDay()}/${date.getMonth()}/${date.getFullYear()}`,
//     amount: items.reduce((acc, item) => acc + item.amount, 0), // getting the amount of item
//   }
//
...
//     y: 400,
//     inc: 150, // this should be inc based on the amount of things on the table
//   };
//
//   return {
//     // genHeader(){
...
//         'brand'
//       ].forEach((text, i) => {
//         console.log('text in genTableHeaders', text);
//         console.log('table ins genTableHeaders', table);
//         doc
//           .fontSize(TEXT_SIZE)
...
//             'brand'
//           ].forEach((field, i) => {
//             console.log(field,' field in getTableRow', i);
//             console.log(item,' in genTableRow');
//             doc
//               .fontSize(TEXT_SIZE)
