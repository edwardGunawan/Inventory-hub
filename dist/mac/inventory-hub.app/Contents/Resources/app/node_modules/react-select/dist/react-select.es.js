import { css, merge, injectGlobal } from 'emotion';
...
var SelectContainer = function SelectContainer(props) {
  ...
  return React.createElement(
    Div,
    _extends({
      className: merge(css(getStyles('container', props)) + (' ' + cx('', { isDisabled: isDisabled, isRtl: isRtl })))
    }, innerProps),
    children
  );
};
    ...
    value: function render() {
      ...
      return React.createElement(
        Div,
        {
          ...
          className: merge(css(getStyles('valueContainer', this.props)) + (' ' + cx('value-container', { isMulti: isMulti, hasValue: hasValue })))
        },
        children
      );
    }
...
var IndicatorsContainer = function IndicatorsContainer(props) {
  ...
  return React.createElement(
    Div,
    {
      className: merge(css(getStyles('indicatorsContainer', props)) + (' ' + cx('indicators')))
    },
    children
  );
};
...
var DropdownIndicator = function DropdownIndicator(props) {
  ...
  return React.createElement(
    'div',
    _extends({}, innerProps, {
      className: merge(css(getStyles('dropdownIndicator', props)) + (' ' + cx(['indicator', 'dropdown-indicator'])))
    }),
    children
  );
};
...
var ClearIndicator = function ClearIndicator(props) {
  ...
  return React.createElement(
    'div',
    _extends({}, innerProps, {
      className: merge(css(getStyles('clearIndicator', props)) + (' ' + cx(['indicator', 'clear-indicator'])))
    }),
    children
  );
};
...
var IndicatorSeparator = function IndicatorSeparator(props) {
  ...
  return React.createElement('span', _extends({}, innerProps, {
    className: merge(css(getStyles('indicatorSeparator', props)) + (' ' + cx('indicator-separator')))
  }));
};
...
var LoadingIndicator = function LoadingIndicator(props) {
  ...
  return React.createElement(
    'div',
    _extends({}, innerProps, {
      className: merge(css(getStyles('loadingIndicator', props)) + (' ' + cx(['indicator', 'loading-indicator'])))
    }),
...
var Control = function Control(props) {
  ...
  return React.createElement(
    Div,
    _extends({
      className: merge(css(getStyles('control', props)) + (' ' + cx('control', { isDisabled: isDisabled, isFocused: isFocused })))
    }, innerProps),
    children
  );
};
...
var Group = function Group(props) {
  ...
  return React.createElement(
    Div,
    _extends({
      className: merge(css(getStyles('group', props)) + (' ' + cx('group')))
    }, innerProps),
    React.createElement(
      Heading,
...
var GroupHeading = function GroupHeading(props) {
  ...
  return React.createElement(Div, _extends({
    className: merge(css(getStyles('groupHeading', props)) + (' ' + cx('group-heading')))
  }, cleanProps));
};
  ...
  createClass(Menu, [{
    ...
    value: function render() {
      ...
      return React.createElement(
        Div,
        _extends({
          className: merge(css(getStyles('menu', this.getState())) + (' ' + cx('menu'))),
...
var MenuList = function MenuList(props) {
  ...
  return React.createElement(
    Div,
    _extends({
      className: merge(css(getStyles('menuList', props)) + (' ' + cx('menu-list', { isMulti: isMulti })))
    }, innerProps),
    children
  );
};
...
var NoOptionsMessage = function NoOptionsMessage(props) {
  ...
  return React.createElement(
    Div,
    _extends({
      className: merge(css(getStyles('noOptionsMessage', props)) + (' ' + cx(['menu-notice', 'menu-notice--no-options'])))
    }, innerProps),
    children
  );
};
...
var LoadingMessage = function LoadingMessage(props) {
  ...
  return React.createElement(
    Div,
    _extends({
      className: merge(css(getStyles('loadingMessage', props)) + (' ' + cx(['menu-notice', 'menu-notice--loading'])))
    }, innerProps),
    children
  );
};
...
var MultiValue = function MultiValue(props) {
  ...
  return React.createElement(
    Container,
    _extends({
      className: merge(css(css$$1.container) + (' ' + cn.container))
    }, innerProps),
    React.createElement(
      Label,
      {
        className: merge(css(css$$1.label) + (' ' + cn.label))
      },
      children
    ),
    React.createElement(Remove, _extends({
      className: merge(css(css$$1.remove) + (' ' + cn.remove))
    }, removeProps))
  );
};
...
var Option = function Option(props) {
  ...
  return React.createElement(
    Div,
    _extends({
      className: merge(css(getStyles('option', props)) + (' ' + cx('option', { isFocused: isFocused, isSelected: isSelected })))
    }, innerProps),
    children
  );
};
...
var Placeholder = function Placeholder(props) {
  ...
  return React.createElement(
    Div,
    _extends({
      className: merge(css(getStyles('placeholder', props)) + (' ' + cx('placeholder')))
    }, innerProps),
    children
  );
};
...
var SingleValue = function SingleValue(props) {
  ...
  return React.createElement(
    Div,
    _extends({
      className: merge(css(getStyles('singleValue', props)) + (' ' + cx('single-value', { isDisabled: isDisabled })))
    }, innerProps),
    children
  );
};
